<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
    ...
    <form wire:submit.prevent="submit">
        ...
        <div>
            ...
            <x-text-input wire:model="player_name" id="player_name" class="block mt-1 w-full" type="text" :value="old('player_name')" required autofocus autocomplete="player_name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="jersey_number" id="jersey_number" class="block mt-1 w-full" type="number" min="1" max="22" :value="old('jersey_number')" required autocomplete="jersey_number" />
