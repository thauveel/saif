<div class="mx-auto mb-4">
    <div class="flex items-center justify-between space-x-5">
        ...
        <div class="order-first flex-none rounded-full bg-indigo-400/10 px-2 py-1 text-xs font-medium text-indigo-400 ring-1 ring-inset ring-indigo-400/30 sm:order-none">{{ Str::ucfirst($team->status) }}</div>
        <a href="{{ route('front.apply', $team->tournament). '?team=' . $team->id}}" class="order-first flex gap-1 rounded-full bg-indigo-400/10 px-2 py-1 text-xs font-medium text-indigo-400 ring-1 ring-inset ring-indigo-400/30 sm:order-none">
